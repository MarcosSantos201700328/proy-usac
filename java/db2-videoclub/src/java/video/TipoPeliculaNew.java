...
public class TipoPeliculaNew extends AbstractPageBean {
    ...
    ArrayList<TipoPelicula> cola = new ArrayList<TipoPelicula>();
    ...
    public String button1_action() {
        ...
        if(this.retrieveData("cola") != null)
	        cola  = (ArrayList<TipoPelicula>) this.retrieveData("cola");
        //Ingresamos nuevo registro
        TipoPelicula c = new TipoPelicula();
        c.setIdTipoPelicula(new java.math.BigDecimal(t1.getText().toString()));
        c.setNombre(t2.getText().toString());
        c.setPrecio(Double.parseDouble(t3.getText().toString()));
