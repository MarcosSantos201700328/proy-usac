...
public class ClienteNew extends AbstractPageBean {
    ...
    public String button1_action() {
        ...
        if(this.retrieveData("cola") != null)
	        cola  = (ArrayList<Cliente>) this.retrieveData("cola");
        //Ingresamos nuevo registro
        Cliente c = new Cliente();        
        c.setIdCliente(new java.math.BigDecimal( this.t1.getText().toString()));
        c.setNombre(this.t2.getText().toString());
        c.setTelefono(this.t3.getText().toString());
        c.setDireccion(this.t4.getText().toString());
        c.setSexo(this.t5.getText().toString().charAt(0));
        c.setFechaAfiliacion(this.calendar1.getSelectedDate());
        c.setFechaNac(this.calendar2.getSelectedDate());
        //agregamos a la cola
        cola.add(c);
        //guardamos la data
