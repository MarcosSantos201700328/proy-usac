...
public class FechaNew extends AbstractPageBean {
    ...
    ArrayList<Fecha> cola = new ArrayList<Fecha>();
    ...
    public String button1_action() {
        ...
        if(this.retrieveData("cola") != null)
	        cola  = (ArrayList<Fecha>) this.retrieveData("cola");
        //Ingresamos nuevo registro
        //FechaPK fpk = new FechaPK(idTipoPelicula, idPelicula)
        FechaPK fp = new FechaPK(
                new java.math.BigInteger(this.t1.getText().toString()),
                new java.math.BigInteger(this.t2.getText().toString())
                );
        Fecha c = new Fecha(fp, this.calendar1.getSelectedDate());
