...
public class PeliculaNew extends AbstractPageBean {
    ...
    public void setT3(TextField tf) {
        this.t3 = tf;
    }
    ...
    public void setT4(TextField tf) {
        this.t4 = tf;
    }
    ...
    public void setT5(TextField tf) {
        this.t5 = tf;
    }
    ...
    ArrayList<Pelicula> cola = new ArrayList<Pelicula>();
    ...
    public TextField getT6() {
        return t6;
    }

    public void setT6(TextField tf) {
        this.t6 = tf;
    }
    /**
    ...
    public String button1_action() {
        ...
        if(this.retrieveData("cola") != null)
	        cola  = (ArrayList<Pelicula>) this.retrieveData("cola");
        //Ingresamos nuevo registro
        Pelicula c = new Pelicula();        
        c.setIdPelicula(new java.math.BigDecimal( this.t1.getText().toString()));
        c.setNombre(this.t2.getText().toString());
        c.setFechaEstreno(this.calendar1.getSelectedDate());
        c.setDescrip(this.t3.getText().toString());
        c.setClasif(this.t4.getText().toString().charAt(0));
        c.setConocidaComo(this.t5.getText().toString());
        c.setNumEjemplares(new java.math.BigInteger( this.t6.getText().toString()));
