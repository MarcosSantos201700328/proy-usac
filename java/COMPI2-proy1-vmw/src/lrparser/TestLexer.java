...
public class TestLexer implements lrparser.Scanner {
...
public int getChar(){
	...
	public TestLexer (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public TestLexer (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
...
"9:9,8:2,9,8:2,9:18,8,9:7,6,7,4,2,9,3,9,5,1:10,9:70,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,12,
"0,1,2,1:7,3,4")[0];

	private int yy_nxt[][] = unpackFromString(5,10,
"1,2,3,4,5,6,7,8,11,9,-1:11,2,-1:8,1,-1:17,11,-1");

	public lrparser.Token next_token ()
		throws java.io.IOException {
		int yy_lookahead;
