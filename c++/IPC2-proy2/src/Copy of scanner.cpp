...
#define E_crear_tipo_instalacion 41
#define E_agregar_instalacion    42
#define E_agregar_cliente        43
#define E_crear_promocion        44
#define E_crear_tipo_actividad   45
#define E_hacer_reservacion      46
#define E_extender_reservacion   47
#define E_eliminar_reservacion   48
#define E_asignar_consumo        49
#define E_cambiar_descuento      50
#define E_consultar_descuento    51
#define E_consultar_precio       52
#define E_instalacion_disponib   53
#define E_listar_clientes        54
#define E_listar_reservaciones   55
#define E_calcular_gasto_reserv  56
...
struct Reservadas Rec_Res[16]={
  {"CREAR_TIPO_INSTALACION",41},
  {"AGREGAR_INSTALACION",42},
  {"AGREGAR_CLIENTE",43},
  {"CREAR_PROMOCION",44},
  {"CREAR_TIPO_ACTIVIDAD",45},
  {"HACER_RESERVACION",46},
  {"EXTENDER_RESERVACION",47},
  {"ELIMINAR_RESERVACION",48},
  {"ASIGNAR_CONSUMO_AYB",49},
  {"CAMBIAR_DESCUENTO",50},
  {"CONSULTAR_DESCUENTO",51},
  {"CONSULTAR_PRECIO",52},
  {"INSTALACIONES_DISPONIBLES",53},
  {"LISTAR_CLIENTES",54},
  {"LISTAR_RESERVACIONES",55},
  {"CALCULAR_GASTO_RESERVA",56},
};
