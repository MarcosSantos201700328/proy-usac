...
"PRERRQUISITO_FK" foreign key ("CARRERA","PLAN") references "PLAN" ("CARRERA","PLAN") 
on delete cascade;

alter table "PRERREQUISITO" add constraint
"PRERRQUISITO_FK2" foreign key ("CODIGO") references "CURSO" ("CURSO") 
on delete cascade;
