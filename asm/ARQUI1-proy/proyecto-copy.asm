...
%include "macros.mac"
;todo:
;completar procesar_tarea
;debugear delay de la hora
;;--------------------------------------------------------------------------------------
;; DATOS
section .data
breakline: db 10,13,'$'
pregunta1: db "Desea Continuar?, s: si, otra tecla: no.",10,13,'$' ;; pregunta de main
preguntavol: db "Ingrese volumen (en centilitros):",10,13,'$' ;; pregunta de volumen
preguntacant: db "Ingrese cantidad de envases (en centilitros):",10,13,'$' ;; pregunta de cantidad
estado_title: db "Estado: ",'$' ; titulo de estado
estado_esperando: db "Esperando recipiente.",10,13,'$' ;estado de esperando recipiente
estado_error_nrecip: db "ERROR, no se encontro recipiente",10,13,'$' ;  estado de error sino hay recipiente
estado_vasolleno: db "Recipiente llenado satisfactoriamente.",10,13,'$' ;  estado de vaso lleno
estado_llenando_backup: db "Llenando tanque principal.",10,13,'$' ; 
estado_llenando_vaso: db "Llenando vaso.",10,13,'$' ; 
errnum: db "Por favor ingrese un entre 1 y 9.",10,13,'$'
;respuesta1: resb 1 ;; respuesta de main
volumen: resb 1 ;; se almacenara aqui los mililitros
cantidad: resb 1 ;; se almacenara aqui la cantidad de botellas a llenar
tiempollenado: db 3
...
;tipo de reporte
tipo_reporte db 0
hora: resb 2;;hora para delay
minuto: resb 2;; minuto para delay
segundo: resb 2;; segundo para delay

horabak: resb 2;;backup hora para delay 
minutobak: resb 2;;backup minuto para delay
segundobak: resb 2;;backup segundo para delay
...
esperar_recipiente:
	...
	je detener_banda
	call cmp_hora_delay
	cmp bl,0 ; si no se ha cumplido el tiempo, seguimos esperando
